  ...
  <section className="py-24 relative">
    <div className="container mx-auto px-4">
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="max-w-4xl mx-auto gradient-card rounded-2xl border-glow overflow-hidden"
      >
        {/* Dashboard header */}
        ...
        <div className="p-6 grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2">
              {tasks.map((t) => (
                <div key={t.title} className="flex items-center gap-3 py-2 px-3 rounded-lg bg-secondary/50">
                  {t.status === "done" ? (
